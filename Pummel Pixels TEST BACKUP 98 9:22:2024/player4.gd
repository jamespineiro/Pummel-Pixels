...
@export var player_index = GameSettings.player4_player_index
var team_name = "team-four"

@onready var player_1 : CharacterBody2D
@onready var player_2 : CharacterBody2D
@onready var player_3 : CharacterBody2D

var dodge_meter_4_image = preload("res://assets/Player4/Player4DodgeMeter4.png")
var dodge_meter_3_image = preload("res://assets/Player4/Player4DodgeMeter3.png")
var dodge_meter_2_image = preload("res://assets/Player4/Player4DodgeMeter2.png")
var dodge_meter_1_image = preload("res://assets/Player4/Player4DodgeMeter1.png")
var dodge_meter_0_image = preload("res://assets/Player4/Player4DodgeMeter0.png")
...
func _ready():
	...
	if not GameSettings.player4_selected:
		queue_free()
	else:
		visible = true
