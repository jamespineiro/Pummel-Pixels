...
@export var player_index = GameSettings.player2_player_index
var team_name = "team-two"

@onready var player_1 : CharacterBody2D
@onready var player_3 : CharacterBody2D
@onready var player_4 : CharacterBody2D

var dodge_meter_4_image = preload("res://assets/Player2DodgeMeter4.png")
var dodge_meter_3_image = preload("res://assets/Player2DodgeMeter3.png")
var dodge_meter_2_image = preload("res://assets/Player2DodgeMeter2.png")
var dodge_meter_1_image = preload("res://assets/Player2DodgeMeter1.png")
var dodge_meter_0_image = preload("res://assets/Player2DodgeMeter0.png")
...
func _ready():
	...
	if not GameSettings.player2_selected:
		queue_free()
	else:
		visible = true
