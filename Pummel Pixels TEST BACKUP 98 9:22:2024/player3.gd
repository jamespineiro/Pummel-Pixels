...
@export var player_index = GameSettings.player3_player_index
var team_name = "team-three"
@onready var player_1 : CharacterBody2D
@onready var player_2 : CharacterBody2D
@onready var player_4 : CharacterBody2D

var dodge_meter_4_image = preload("res://assets/Player3/Player3DodgeMeter4.png")
var dodge_meter_3_image = preload("res://assets/Player3/Player3DodgeMeter3.png")
var dodge_meter_2_image = preload("res://assets/Player3/Player3DodgeMeter2.png")
var dodge_meter_1_image = preload("res://assets/Player3/Player3DodgeMeter1.png")
var dodge_meter_0_image = preload("res://assets/Player3/Player3DodgeMeter0.png")
...
func _ready():
	...
	if GameSettings.current_team_type == GameSettings.TEAM_TYPE.TWOVSTWO:
		...
		if team_choice == 0:
			if GameSettings.blue_team.size() > 0 and (GameSettings.red_team.size() - GameSettings.blue_team.size() < 1):
				team_name = "red-team"
			...
			if GameSettings.red_team.size() > 0 and (GameSettings.blue_team.size() - GameSettings.red_team.size() < 1):
				team_name = "blue-team"
				GameSettings.blue_team.append(self)
			else:
				team_name = "red-team"
	...
	if not GameSettings.player3_selected:
		queue_free()
	else:
		visible = true
