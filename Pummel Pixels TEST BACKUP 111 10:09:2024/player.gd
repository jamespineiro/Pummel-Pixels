...
var player_index = 0
@onready var team_name = team_names[0]
...
var dodge_meter_4_images = [preload("res://assets/Player1DodgeMeter4.png"), preload("res://assets/Player2DodgeMeter4.png"), preload("res://assets/Player3/Player3DodgeMeter4.png"), preload("res://assets/Player4/Player4DodgeMeter4.png")]
var dodge_meter_3_images = [preload("res://assets/Player1DodgeMeter3.png"), preload("res://assets/Player2DodgeMeter3.png"), preload("res://assets/Player3/Player3DodgeMeter3.png"), preload("res://assets/Player4/Player4DodgeMeter3.png")]
var dodge_meter_2_images = [preload("res://assets/Player1DodgeMeter2.png"), preload("res://assets/Player2DodgeMeter2.png"), preload("res://assets/Player3/Player3DodgeMeter2.png"), preload("res://assets/Player4/Player4DodgeMeter2.png")]
var dodge_meter_1_images = [preload("res://assets/Player1DodgeMeter1.png"), preload("res://assets/Player2DodgeMeter1.png"), preload("res://assets/Player3/Player3DodgeMeter1.png"), preload("res://assets/Player4/Player4DodgeMeter1.png")]
var dodge_meter_0_images = [preload("res://assets/Player1DodgeMeter0.png"), preload("res://assets/Player2DodgeMeter0.png"), preload("res://assets/Player3/Player3DodgeMeter0.png"), preload("res://assets/Player4/Player4DodgeMeter0.png")]
...
@onready var dodge_meter_images = [dodge_meter_0_images[player_index], dodge_meter_1_images[player_index],
dodge_meter_2_images[player_index], dodge_meter_3_images[player_index], dodge_meter_4_images[player_index]]
...
func _ready():
	...
	team_name = team_names[player_index]
	dodge_meter_images = [dodge_meter_0_images[player_index], dodge_meter_1_images[player_index],
	dodge_meter_2_images[player_index], dodge_meter_3_images[player_index], dodge_meter_4_images[player_index]]
	...
	if team_name == "red-team":
		dodge_meter_4_images[player_index] = preload("res://assets/RedDodgeMeter4.png")
		dodge_meter_3_images[player_index] = preload("res://assets/RedDodgeMeter3.png")
		dodge_meter_2_images[player_index] = preload("res://assets/RedDodgeMeter2.png")
		dodge_meter_1_images[player_index] = preload("res://assets/RedDodgeMeter1.png")
		dodge_meter_0_images[player_index] = preload("res://assets/RedDodgeMeter0.png")
		dodge_meter_ui.texture = dodge_meter_4_images[player_index]
		dodge_meter_images = [dodge_meter_0_images[player_index], dodge_meter_1_images[player_index],
		dodge_meter_2_images[player_index], dodge_meter_3_images[player_index], dodge_meter_4_images[player_index]]
	elif team_name == "blue-team":
		dodge_meter_4_images[player_index] = preload("res://assets/BlueDodgeMeter4.png")
		dodge_meter_3_images[player_index] = preload("res://assets/BlueDodgeMeter3.png")
		dodge_meter_2_images[player_index] = preload("res://assets/BlueDodgeMeter2.png")
		dodge_meter_1_images[player_index] = preload("res://assets/BlueDodgeMeter1.png")
		dodge_meter_0_images[player_index] = preload("res://assets/BlueDodgeMeter0.png")
		dodge_meter_ui.texture = dodge_meter_4_images[player_index]
		dodge_meter_images = [dodge_meter_0_images[player_index], dodge_meter_1_images[player_index],
		dodge_meter_2_images[player_index], dodge_meter_3_images[player_index], dodge_meter_4_images[player_index]]
		
			
	if player_index == 0 and not GameSettings.player1_selected:
		queue_free()
	elif player_index == 1 and not GameSettings.player2_selected:
		queue_free()
	elif player_index == 2 and not GameSettings.player3_selected:
		queue_free()
	elif player_index == 3 and not GameSettings.player4_selected:
		queue_free()
	else:
		visible = true
	...
	if player_index != 0 and GameSettings.player1_selected:
		player_1 = get_node("../player")
		add_collision_exception_with(player_1)
	if player_index != 1 and GameSettings.player2_selected:
		player_2 = get_node("../player2")
		add_collision_exception_with(player_2)
	if player_index != 2 and GameSettings.player3_selected:
		player_3 = get_node("../player3")
		add_collision_exception_with(player_3)
	if player_index != 3 and GameSettings.player4_selected:
...
func _physics_process(delta):
	...
	if (current_animation == animation.SLIDING or current_animation == animation.CROUCHING) and crouch_slide_hitbox.disabled:
		crouch_slide_hitbox.disabled = false
		collision_shape_2d.disabled = true
	elif (current_animation == animation.CRYING or current_animation == animation.AIRCRYING) and cry_hitbox.disabled and sprite.get_frame() >= 4 and sprite.get_frame() < 9:
		if sprite.flip_h:
			cry_hitbox_flipped.disabled = false
			cry_hitbox.disabled = true
		else:
			cry_hitbox.disabled = false
			cry_hitbox_flipped.disabled = true
		collision_shape_2d.disabled = true
	elif (current_animation != animation.SLIDING and current_animation != animation.CROUCHING and (current_animation != animation.CRYING or current_animation == animation.CRYING and (sprite.get_frame() > 8 or sprite.get_frame() < 4)) and (current_animation != animation.AIRCRYING or current_animation == animation.AIRCRYING and (sprite.get_frame() > 8 or sprite.get_frame() < 4))) and (collision_shape_2d.disabled or not cry_hitbox.disabled or not cry_hitbox_flipped.disabled or not crouch_slide_hitbox.disabled):
		collision_shape_2d.disabled = false
		cry_hitbox.disabled = true
		cry_hitbox_flipped.disabled = true
		crouch_slide_hitbox.disabled = true
	...
	if player_index == 0:
		...
		GameSettings.player2_knockouts = knockouts
		GameSettings.player2_dmg_dealt = dmg_dealt
		GameSettings.player2_dmg_taken = dmg_taken
	elif player_index == 2:
		GameSettings.player3_knockouts = knockouts
		GameSettings.player3_dmg_dealt = dmg_dealt
		GameSettings.player3_dmg_taken = dmg_taken
	elif player_index == 3:
		GameSettings.player4_knockouts = knockouts
		GameSettings.player4_dmg_dealt = dmg_dealt
		GameSettings.player4_dmg_taken = dmg_taken
	...
	if not stunned and not hit:
		if (not dead) and (not (is_on_floor()) or current_animation == animation.CROUCHING or current_animation == animation.GROUNDAIRUPATTACKING or Input.is_action_just_pressed("sprint"+str(player_index)) or  Input.is_action_just_released("sprint"+str(player_index))):
			if (Input.is_action_just_released("down"+str(player_index)) or direction != 0 or not is_on_floor() or Input.is_action_just_pressed("attack"+str(player_index)) or Input.is_action_just_pressed("special"+str(player_index)) or Input.is_action_just_pressed("right_stick_down"+str(player_index)) ) and current_animation == animation.CROUCHING:
				if Input.is_action_just_pressed("attack"+str(player_index)):
				...
				elif Input.is_action_just_pressed("special"+str(player_index)) or Input.is_action_just_pressed("right_stick_down"+str(player_index)):
					...
					if not crying:
						crying = true
						cry_timer.start()
				elif current_animation == animation.CROUCHING:
					sprite.play("idle")
			...
			elif (Input.is_action_just_released("jump"+str(player_index)) and current_animation == animation.GLIDING) or (current_animation != animation.CROUCHING and current_animation != animation.DOWNATTACKING and current_animation != animation.AIRCRYING and current_animation != animation.AIRSHIELDING and current_animation != animation.GROUNDAIRUPATTACKING and current_animation != animation.SHIELDING and current_animation != animation.NEUTRALDODGING and current_animation != animation.SAIRATTACK and current_animation != animation.UPDODGING and current_animation != animation.DOWNDODGING and current_animation != animation.SIDEDODGING and current_animation != animation.AIRDOWNATTACKING and current_animation != animation.AIRUPATTACKING and current_animation != animation.GLIDING and current_animation != animation.DAIRSPECIALING and current_animation != animation.AIRPUNCHING and current_animation != animation.CROSSBOWING and current_animation != animation.AIRCROSSBOWING and current_animation != animation.AIRSPECIALING):
				if SPEED == NORMAL_SPEED and (current_animation != animation.SATTACK1 and current_animation != animation.CRYING and current_animation != animation.AIRCRYING and current_animation != animation.SATTACK2 and current_animation != animation.SATTACK3 and current_animation != animation.AIRCRYING and current_animation != animation.AIRSHIELDING and current_animation != animation.GROUNDAIRUPATTACKING and current_animation != animation.SHIELDING and current_animation != animation.NEUTRALDODGING and current_animation != animation.SAIRATTACK and current_animation != animation.UPDODGING and current_animation != animation.DOWNDODGING and current_animation != animation.SIDEDODGING and current_animation != animation.AIRDOWNATTACKING and current_animation != animation.AIRUPATTACKING and current_animation != animation.DAIRSPECIALING and current_animation != animation.AIRPUNCHING and current_animation != animation.CROSSBOWING and current_animation != animation.AIRCROSSBOWING and current_animation != animation.AIRSPECIALING):
					sprite.play("jumping")
					current_animation = animation.JUMPING
	...
	if (not is_on_floor()) and (((velocity.y * delta) > 5 or gravity_capped) and not hit) and (current_animation == animation.JUMPING or current_animation == animation.CHARGING):
		...
		if event.is_action_pressed("dodge" + str(player_index)) and current_animation != animation.NEUTRALDODGING and current_animation != animation.UPDODGING and current_animation != animation.DOWNDODGING and current_animation != animation.SIDEDODGING:
			...
			if is_on_floor():
				if event.is_action_pressed("atk_neutral"+str(player_index)):
					...
					if current_animation == animation.CROUCHING and (event.is_action_pressed("attack"+str(player_index)) and (Input.is_action_pressed("down"+str(player_index)))):
						up_attack_sword_slash.pitch_scale = randf_range(1.15, 1.40)
						up_attack_sword_slash.play()
						sprite.play("up_attack")
						current_animation = animation.UPATTACKING
					elif current_animation == animation.CROUCHING and ((event.is_action_pressed("special"+str(player_index)) and (Input.is_action_pressed("down"+str(player_index)))) or Input.is_action_pressed("right_stick_down"+str(player_index))):
						cry_sound.pitch_scale = randf_range(1.50, 1.70)
						cry_sound.play()
						sprite.play("down_special_ground")
						current_animation = animation.CRYING
						...
						sprite.play("emote")
						current_animation = animation.EMOTING
					elif current_animation == animation.IDLE and not event.is_action_pressed("attack"+str(player_index)) and event.is_action_pressed("down" + str(player_index)):
						sprite.play("crouching")
						current_animation = animation.CROUCHING
			else: # if in air
				if event.is_action_pressed("atk_neutral"+str(player_index)):
	...
	if not scoreboard.game_just_finished:
		if not dead:
			if player_who_hit_me_last != null:
				...
				if player_index != 0 and player_1 != null and player_1.team_name != team_name:
					if not juggernaut:
						player_1.score += 1
					...
					if juggernaut:
						dejuggify()
						player_1.juggify()
				elif player_index != 1 and player_2 != null and player_2.team_name != team_name:
					if not juggernaut:
						player_2.score += 1
					...
					if juggernaut:
						dejuggify()
						player_2.juggify()
				elif player_index != 2 and player_3 != null and player_3.team_name != team_name:
					if not juggernaut:
						player_3.score += 1
					...
					if juggernaut:
						dejuggify()
						player_3.juggify()
				elif player_index != 3 and player_4 != null and player_4.team_name != team_name:
					if not juggernaut:
						player_4.score += 1
...
func _on_animated_sprite_2d_animation_finished():
	...
	if is_on_floor():
		if current_animation == animation.SATTACK1 or current_animation == animation.SATTACK2:
			...
			atk_count = 0
			side_attacking = false
		if direction == 0 and current_animation != animation.CROUCHING:
			sprite.play("idle")
			current_animation = animation.IDLE
		elif direction != 0:
			sprite.play("running")
...
func _on_attack_hurt_box_body_entered(body):
	if body != self:
		if body is CharacterBody2D:
			if body.has_method("shoot_arrow") or body.is_in_group("Dummies"):
